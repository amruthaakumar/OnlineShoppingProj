...
//"d@yahoo.in"   session.getAttribute("email").toString();   request.getParameter("email")
...
ResultSet rs1=st.executeQuery("select *from cart where product_id='"+product_id+"'and email='"+strEmail+"' and address is NULL");
while(rs1.next())
{
...
if(z==1)
{
 st.executeUpdate("update cart set total='"+cart_total+"',quantity='"+quantity+"' where product_id='"+product_id+"' and email='"+strEmail+"' and address is NULL");
