...
{
%>
<h3 class="alert">There is only one Quantity! So please click on remove item!</h3>
<%} %>
<%
if("inc".equals(msg))
{
	...
	%>
          ...
          <%sno=sno+1;%>
           <td><%out.println(sno);%></td>
            ...
            <td><a href="incDecQuantityAction.jsp?id=<%out.println(rs.getString(1));%>&quantity=inc"><i class='fas fa-plus-circle'></i></a> <%out.println(rs.getString(8));%> <a href="incDecQuantityAction.jsp?id=<%out.println(rs.getString(1));%>&quantity=dec"><i class='fas fa-minus-circle'></i></a></td>
